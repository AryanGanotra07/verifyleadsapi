...
zohoApi = "https://mail.zoho.in/api/accounts/537360000000002002/messages"
...
def sendEmail(data):
    ...
    email = data['email']
    data =  {
   "fromAddress": "contact@verifyleads.io",
   "toAddress": email,
   "ccAddress": "",
   "bccAddress": "",
   ...
   "askReceipt" : "yes"
    ...
    headers = {'Content-Type': 'application/json', 'Authorization' : '93f5bcc9817d76059bd1e0d9e382bbdf'}
